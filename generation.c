...
void GENERATION_INPUTI(){
    ...
    printf("JUMPIFEQ $INPUTF_END LF@$retval_check  int@nil\n");
...
void GENERATION_INPUTS(){
    ...
    printf("TYPE LF@$retval_check LF@retval\n");
    printf("JUMPIFEQ $INPUTS_END LF@$retval_check  string@nil\n");
    printf("PUSHS LF@retval\n");
...
void GENERATION_INPUTF(){
    ...
    printf("DEFVAR LF@retval\n");
    printf("DEFVAR LF@retval_check\n");
    printf("READ LF@$retval float@nil\n");

    printf("TYPE LF@$retval_check LF@retval\n");
    printf("JUMPIFEQ $INPUTF_END LF@$retval_check  float@nil\n");
    printf("PUSHS LF@retval\n");
    printf("MOVE LF@retval$1 int@0\n");
    printf("PUSHS LF@retval$1\n");
    printf("JUMP $END\n");
...
void GENERATION_SUBSTR(){
    ...
    printf("GT LF@result LF@length_helper LF@new_strlen\n");
	printf("JUMPIFEQ $SUBSTR_END LF@result bool@true\n");
	printf("LABEL $SUBSTR_END LF@result bool@true\n");
	printf("MOV LF@length_helper LF@new_strlen\n");

    printf("GETCHAR LF@char LF@string LF@from\n");

	printf("LABEL $for_loop\n");
    printf("JUMPIFEQ $SUBSTR_END LF@length_helper LF@from\n");
    printf("GETCHAR LF@char LF@string LF@from\n");
